...
export function AlgoViewerHeaderUsingOnlyName({ name, irToSpecMapping }: { name: string, irToSpecMapping: IrToSpecMapping }) {
  ...
  return (<>
    ...
    }
    {
      ...
      <div className="px-2 flex flex-col mb-1 break-all">
      <p className="px-2 font-300">
        <b className="size-14 text-black font-es">{specInfo?.methodInfo[0]}</b>
      </p>
      </div>
    }
    </>
