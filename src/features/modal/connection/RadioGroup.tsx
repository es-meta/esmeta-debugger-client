        ...
        >
          {options.map(o => (
            <Radio
              ...
              focus:outline-none data-[focus]:outline-1 data-[focus]:outline-es-900 data-[checked]:bg-gradient-to-r data-[checked]:from-es-500/60 dark:data-[checked]:from-es-900/60 data-[checked]:to-es-500/5 dark:data-[checked]:to-es-900/5"
            >
