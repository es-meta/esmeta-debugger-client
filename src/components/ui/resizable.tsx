...
const ResizablePanelGroup = ({
  ...
  return (
    <ResizablePrimitive.Group
      data-panel-group-direction={resolvedOrientation ?? "horizontal"}
...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="z-10 flex h-4 w-3 items-center justify-center rounded-sm border bg-neutral-300 dark:bg-neutral-700">
